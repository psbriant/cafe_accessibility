...
bus_stops = bus_stops[['STOP_ID', 'STOP_STATUS', 'XCOORD', 'YCOORD', 'STOP_TYPE', 'ON_STREET_NAME', 'HASTUS_CROSS_STREET_NAME', 'AUTH_NAME', 'ZIPCODE', 'ROUTE_LIST']]
...
bus_stops = bus_stops[(bus_stops["ZIPCODE"] >= 98101) & (bus_stops["ZIPCODE"] <= 98199)]

# Filter for stop owners that are within Seattle city limits
bus_stops = bus_stops[bus_stops["AUTH_NAME"].isin(['Seattle', 'Port of Seattle', 'Unknown',
       'University of Washington', 'State Dept. of Transportation',
       'Private Owner', 'Boeing Aircraft Corporation',
       'South Seattle Community College', 'Federal Government'])]
